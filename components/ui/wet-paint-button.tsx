...
const WetPaintButton = ({ children, className }: { className?: string; children: React.ReactNode }) => {
  return (
    <button
      className={cn("wet-paint-btn rounded-full px-5 py-3 text-sm md:px-8 md:py-4 md:text-xl font-black text-white tracking-wide cursor-pointer transition-all relative overflow-hidden", className)}
