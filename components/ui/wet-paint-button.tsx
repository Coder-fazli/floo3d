...
const WetPaintButton = ({ children, className }: { className?: string; children: React.ReactNode }) => {
  return (
    <button
      className={cn("wet-paint-btn rounded-xl px-8 py-4 text-xl font-black text-white tracking-wide cursor-pointer transition-all relative overflow-hidden", className)}
