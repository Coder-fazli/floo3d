...
const floorPlanStyles: Record<string, string> = {
  Modern:       "large-format light grey or white polished concrete or stone tile floors, pure white smooth walls, sleek low-profile furniture with clean straight lines — no carvings, no curves, no patterns, recessed ceiling lighting only, strict neutral palette of white, grey and black, no warm wood tones, no plants, no organic textures",
