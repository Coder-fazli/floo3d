    ...
    <div className="legal-page">
      ...
      <div className="legal-body">
        ...
        <div className="legal-section">
          ...
          <p>AI-generated results are produced by Google Gemini AI models and may vary in quality and accuracy. Results are not guaranteed to be architecturally precise or construction-ready.</p>
        </div>
        ...
        <div className="legal-section">
          ...
          <p>Our AI renders are generated by Google Gemini AI and are intended for visualization purposes only. They are:</p>
          <ul>
